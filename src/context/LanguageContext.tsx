...
export const translations = {
  ...
  BG: {
    ...
    winterGardensDesc: 'Премиум стъклени конструкции, които безпроблемно комбинират вътрешния комфорт с външната красота, създавайки елегантни пространства през цялата година.',
    ...
    hplFacadesDesc: 'Панели с висок натиск, предлагащи превъзходна издържливост, устойчивост на време и разнообразие на дизайна.',
    bondFacades: 'Bond фасади и облицовки',
    bondFacadesDesc: 'Напредни системи от композитни панели с изключителна топлинна ефективност и поразително визуално въздействие.',
    ...
    corporateHplDesc: 'Съвременна реновация на фасада с използване на панели с висок натиск за комерсиално офис сграда.',
    ...
    contactDesc: 'Свържете се с нас, за да обсудите вашия индустриален конструкционен проект',
    address: 'Адрес',
    phone: 'Телефон',
    email: 'Имейл',
    sofiaAddress: 'София, район Красна поляна',
